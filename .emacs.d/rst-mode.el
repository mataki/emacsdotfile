...
;; =head1 SYNOPSIS
;;
;; Add the following lines to your F<.emacs> file:
;;
...
;;
;; If you are using F<.txt> as a standard extension for reST files as
;; http://docutils.sourceforge.net/FAQ.html#what-s-the-standard-filename-extension-for-a-restructuredtext-file
;; suggests you may use one of the I<Local Variables in Files> mechanism Emacs
...
;; feature off. See I<Local Variables in Files> in the Emacs documentation for
...
;; mode.
;;
;; The package is based on C<text-mode> and inherits some things from it.
;; Particularly C<text-mode-hook> is run before C<rst-mode-hook>.
...
;;
;; The group is contained in the C<wp> group.
;;
;; =item rst-faces
;;
;; This group contains all necessary for customizing fonts. The default
;; settings use standard C<font-lock-*-face>s so if you set these to your
;; liking they are probably good in C<rst-mode> also.
;;
;; The group is contained in the C<faces> group as well as in the C<rst> group.
;;
;; =item rst-faces-defaults
;;
